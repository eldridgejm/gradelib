...
def test_average_gpa():
    ...
    # when
    gpa = gradelib.summarize.average_gpa(letters)
...
def test_average_gpa_without_failing_grades():
    ...
    # when
    gpa_1 = gradelib.summarize.average_gpa(letters)
    gpa_2 = gradelib.summarize.average_gpa(letters, include_failing=True)
...
def test_distribution():
    ...
    # when
    distribution = gradelib.summarize.letter_grade_distribution(letters)
