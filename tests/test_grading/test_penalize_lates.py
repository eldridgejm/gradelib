...
def test_without_forgiveness_or_within_penalizes_all_lates():
    ...
    gradelib.grading.penalize_lates(gradebook)
...
def test_with_callable_deduction():
    ...
    gradelib.grading.penalize_lates(gradebook, deduction=deduction)
...
def test_with_callable_deduction_does_not_count_forgiven():
    ...
    gradelib.grading.penalize_lates(gradebook, deduction=deduction, forgive=1)
...
def test_within_assignments():
    ...
    gradelib.grading.penalize_lates(gradebook, within=HOMEWORK)
...
def test_with_forgiveness():
    ...
    gradelib.grading.penalize_lates(gradebook, forgive=1)
...
def test_with_forgiveness_and_within():
    ...
    gradelib.grading.penalize_lates(gradebook, within=HOMEWORK, forgive=2)
    gradelib.grading.penalize_lates(gradebook, within=["lab01"])
...
def test_with_forgiveness_forgives_most_valuable_assignments_first_by_default():
    ...
    gradelib.grading.penalize_lates(gradebook, within=HOMEWORK + LABS, forgive=2)
...
def test_forgives_the_first_n_lates_when_order_by_is_index():
    ...
    gradelib.grading.penalize_lates(gradebook, within=HOMEWORK + LABS, forgive=2, order_by="index")
...
def test_with_empty_assignment_list_raises():
    ...
    with pytest.raises(ValueError):
        gradelib.grading.penalize_lates(gradebook, within=[])
...
def test_with_forgiveness_adds_note_for_forgiven_assignments():
    ...
    gradelib.grading.penalize_lates(gradebook, forgive=2)
